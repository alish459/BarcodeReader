...
namespace BarcodeSolution
{
    class GoodsDefinition : System.Windows.Forms.Form
    {
        ...
        private List<Connection.Model.Inventory> Result = new List<Connection.Model.Inventory>();
        ...
        private void SetGrid()
        {
            ...
            dataGridView1.Columns["Barcode"].HeaderText = "باركد";
        ...
        {
            if (Connection.CrudService.InventoryCrud.Create(new Connection.Model.Inventory() { Barcode = txtBarcode.Text, Name = txtNaka.Text }))
            {
